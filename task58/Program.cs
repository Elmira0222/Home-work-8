...
Console.WriteLine("Specify Two Matrices.");
int m = GetNumber("enter the number of rows of the first matrix: ");
int k = GetNumber("enter the number of columns in the first matrix (equal to the number of rows in the second matrix): ");

int[,] matrixA = GetArray(m, k);
Console.WriteLine("First matrix:");
PrintMatrix(matrixA);

int n = GetNumber("enter the number of columns of the second matrix: ");
